...
namespace Finances.Migrations
{
    ...
    [Migration("20160720175037_CreateTransactionsOperationsTables")]
    partial class CreateTransactionsOperationsTables
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Finances.Models.ProductOperation", b =>
                {
                    b.Property<int>("Id");
            ...
            modelBuilder.Entity("Finances.Models.Operation", b =>
                {
                    b.HasOne("Finances.Models.Currency", "Currency")
                        .WithMany()
                        .HasForeignKey("CurrencyId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Finances.Models.Currency", "OriginalCurrency")
                        .WithMany()
                    ...
                    b.HasOne("Finances.Models.Wallet", "Wallet")
                        .WithMany()
            ...
            modelBuilder.Entity("Finances.Models.ProductOperation", b =>
                {
                    b.HasOne("Finances.Models.Operation", "Operation")
                        .WithOne("ProductOperation")
                        .HasForeignKey("Finances.Models.ProductOperation", "Id")
                        .OnDelete(DeleteBehavior.Cascade);
